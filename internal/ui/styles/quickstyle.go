...
func quickStyle(o quickStyleOpts) Styles {
	...
	// Editor
	// Every prompt is exactly 2 columns wide to match SetPromptFunc(2, ...):
	// the ">" arrow sits right next to the input text and the "::" dots
	// keep wrapped lines aligned with it.
	s.Editor.PromptArrowFocused = lipgloss.NewStyle().Foreground(o.accent).SetString("> ")
	s.Editor.PromptArrowBlurred = s.Editor.PromptArrowFocused.Foreground(o.fgMoreSubtle)
	...
	s.Editor.PromptYoloArrowFocused = lipgloss.NewStyle().Foreground(o.warningSubtle).SetString("> ")
	s.Editor.PromptYoloArrowBlurred = s.Editor.PromptYoloArrowFocused.Foreground(o.fgMoreSubtle)
	s.Editor.PromptYoloDotsFocused = lipgloss.NewStyle().Foreground(o.warningSubtle).SetString("::")
	s.Editor.PromptYoloDotsBlurred = s.Editor.PromptYoloDotsFocused.Foreground(o.fgMoreSubtle)
	s.Editor.PromptBangArrowFocused = lipgloss.NewStyle().Foreground(o.primary).SetString("> ")
	s.Editor.PromptBangArrowBlurred = s.Editor.PromptBangArrowFocused.Foreground(o.fgMoreSubtle)
	s.Editor.PromptBangDotsFocused = lipgloss.NewStyle().Foreground(o.primary).SetString("::")
	s.Editor.PromptBangDotsBlurred = s.Editor.PromptBangDotsFocused.Foreground(o.fgMoreSubtle)
	s.Editor.PromptPlanArrowFocused = lipgloss.NewStyle().Foreground(o.primary).SetString("> ")
	s.Editor.PromptPlanArrowBlurred = s.Editor.PromptPlanArrowFocused.Foreground(o.fgMoreSubtle)
	s.Editor.PromptPlanDotsFocused = lipgloss.NewStyle().Foreground(o.primary).SetString("::")
