...
func (s *Server) installHandler() {
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/agent/plan-mode", c.handlePostWorkspaceAgentPlanMode)
	...
	mux.HandleFunc("POST /v1/workspaces/{id}/agent/optimize-prompt", c.handlePostWorkspaceAgentOptimizePrompt)
