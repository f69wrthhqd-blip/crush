...
func (c *scriptedCoordinator) OptimizePrompt(context.Context, string, string) (string, error) {
	return "", nil
}
func (c *scriptedCoordinator) SetPlanMode(bool) {}
func (c *scriptedCoordinator) PlanMode() bool   { return false }
